...
%   - set the author affiliation + contact email below
%   - set the code-repository URL in \coderepo
%   - choose a license at arXiv upload time (CC BY recommended for an open artifact)
...
% --- repository link (edit me) ---
\newcommand{\coderepo}{https://github.com/EmreTuran/AgentGuard}

\title{\textbf{Oversight Has a Capacity:\\ Calibrating Agent Guards to a Subjective, Fatiguing Human}}

\author[1]{Emre Turan\thanks{Correspondence: \texttt{TODO@example.com}. Code and data: \url{\coderepo}.}}
