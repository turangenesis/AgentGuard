...
%   - MAKE THE REPO PUBLIC: turangenesis/AgentGuard is currently PRIVATE; \coderepo must resolve
%   - choose a license at arXiv upload time (CC BY recommended for an open artifact)
%   (done: contact email set; \coderepo points to the real remote; affiliation = Independent Researcher)
